...
// import { Post } from './proxy-route/post';
// import { createDynamicRoute } from './proxy-route/profile-user';
...
const endpoints = ['profile/','basic/', 'pfComplete/', 'education/', 'experience/','reference/','cv/','photo/','apply/','applied/','favorites/'];
